...
public class MatrixDirectionsJsonDeserializer implements JsonDeserializer<MatrixDirectionsResponse> {

    @Inject
    public MatrixDirectionsJsonDeserializer() {
     ...
     */
    @Override
    public MatrixDirectionsResponse deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
        ...
        MatrixDirectionsResult matrixDirectionsResult = context.deserialize(data, MatrixDirectionsResult.class);
        // Build and return response
        return new MatrixDirectionsResponse(version, provider, timestamp, copyright, status, matrixDirectionsResult);
    }
}
