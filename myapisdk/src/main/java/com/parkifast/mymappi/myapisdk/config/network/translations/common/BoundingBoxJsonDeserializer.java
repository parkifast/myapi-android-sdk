...
public class BoundingBoxJsonDeserializer implements JsonDeserializer<BoundingBox> {

    @Inject
    public BoundingBoxJsonDeserializer() {
    ...
    public BoundingBox deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
        ...
        List<String> bBoxComponents = context.deserialize(json.getAsJsonArray(), ArrayList.class);
        // Build and return response
        return new BoundingBox(bBoxComponents);
    }
}
